    ...
    img.onload = () => {
      ...
      this.props.badges.forEach((badge, i, a) => {
        ...
        if (i === a.length - 1) {
          ...
          ctx.fillText(`VERIFICATION TEXT: ${this.props.verText}`, xPos, yPos + 9)
          ctx.fillText(`GENERATED ON: ${generationDate}`, xPos, yPos + 21)
          ctx.fillText("TO VERIFY PROOF, PLEASE VISIT BADGES.ELLIOTFRIEND.COM/VERIFY", xPos, yPos + 34)
